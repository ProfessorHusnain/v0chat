...
export default function SidePanel() {
  return (
    <aside className="">
      <div className="flex h-svh w-60 flex-col bg-slate-50 pt-8 dark:border-slate-700 dark:bg-slate-900 sm:w-64">
        ...
        <div className="mt-auto w-full space-y-4 px-2 py-4">
          <button className="flex w-full items-center gap-x-2 rounded-lg px-3 py-2 text-left text-sm font-medium text-slate-700 transition-colors duration-200 hover:bg-slate-200 focus:outline-none dark:text-slate-200 dark:hover:bg-slate-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              viewBox="0 0 24 24"
